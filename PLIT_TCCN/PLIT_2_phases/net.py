...
class Model(nn.Module):
    ...
    def forward(self, im, lmb=None,train=1):
        ...
        if train==0:
            ...
            snr = self.config.channel['chan_param']
        z_hat_1, cbr_z_1 = self.PLIT_EncDec_1(z_sample_1, prob_1, initial_image, scale_h=1, scale_w=1, train=train,snr=snr)  
        z_hat_2_1, cbr_z_2_1 = self.PLIT_EncDec_2_1(z_sample_2_1, prob_2_1, initial_image, scale_h=2, scale_w=2, train=train,snr=snr) 
        z_hat_2_2, cbr_z_2_2 = self.PLIT_EncDec_2_2(z_sample_2_2, prob_2_2, initial_image, scale_h=2, scale_w=2, train=train,snr=snr)  
        z_hat_3_1, cbr_z_3_1 = self.PLIT_EncDec_3_1(z_sample_3_1, prob_3_1, initial_image, scale_h=2, scale_w=2, train=train,snr=snr)  
        z_hat_3_2, cbr_z_3_2 = self.PLIT_EncDec_3_2(z_sample_3_2, prob_3_2, initial_image, scale_h=2, scale_w=2, train=train,snr=snr)  
        z_hat_3_3, cbr_z_3_3 = self.PLIT_EncDec_3_3(z_sample_3_3, prob_3_3, initial_image, scale_h=2, scale_w=2, train=train,snr=snr)  
        z_hat_4_1, cbr_z_4_1 = self.PLIT_EncDec_4_1(z_sample_4_1, prob_4_1, initial_image, scale_h=4, scale_w=4, train=train,snr=snr)  
        z_hat_4_2, cbr_z_4_2 = self.PLIT_EncDec_4_2(z_sample_4_2, prob_4_2, initial_image, scale_h=4, scale_w=4, train=train,snr=snr) 
        z_hat_4_3, cbr_z_4_3 = self.PLIT_EncDec_4_3(z_sample_4_3, prob_4_3, initial_image, scale_h=4, scale_w=4, train=train,snr=snr)

        # node=3
        feature_next_plit_1, _ = \
            self.compress_1.forward_plit(feature=feature_next_0, z_hat=z_hat_1, cbr_z=cbr_z_1, lmb_embedding=emb,
                                          block=1, threshold=1)
        ...
        feature_next_plit_2_1, _ = \
            self.compress_2_1.forward_plit(feature=feature_next_plit_1, z_hat=z_hat_2_1, cbr_z=cbr_z_2_1,
                                            lmb_embedding=emb, block=1, threshold=2)
        feature_next_plit_2_2, _ = \
            self.compress_2_2.forward_plit(feature=feature_next_plit_2_1, z_hat=z_hat_2_2, cbr_z=cbr_z_2_2,
                                            lmb_embedding=emb, block=1, threshold=3)
        ...
        feature_next_plit_3_1, _ = \
            self.compress_3_1.forward_plit(feature=feature_next_plit_2, z_hat=z_hat_3_1, cbr_z=cbr_z_3_1,
                                            lmb_embedding=emb, block=1, threshold=4)
        feature_next_plit_3_2, _ = \
            self.compress_3_2.forward_plit(feature=feature_next_plit_3_1, z_hat=z_hat_3_2, cbr_z=cbr_z_3_2,
                                            lmb_embedding=emb, block=1, threshold=5)
        feature_next_plit_3_3, _ = \
            self.compress_3_3.forward_plit(feature=feature_next_plit_3_2, z_hat=z_hat_3_3, cbr_z=cbr_z_3_3,
                                            lmb_embedding=emb, block=1, threshold=6)
        ...
        feature_next_plit_4_1, _ = \
            self.compress_4_1.forward_plit(feature=feature_next_plit_3, z_hat=z_hat_4_1, cbr_z=cbr_z_4_1,
                                            lmb_embedding=emb, block=1, threshold=7)
        feature_next_plit_4_2, _ = \
            self.compress_4_2.forward_plit(feature=feature_next_plit_4_1, z_hat=z_hat_4_2, cbr_z=cbr_z_4_2,
                                            lmb_embedding=emb, block=1, threshold=8)
        feature_next_plit_4_3, _ = \
            self.compress_4_3.forward_plit(feature=feature_next_plit_4_2, z_hat=z_hat_4_3, cbr_z=cbr_z_4_3,
                                            lmb_embedding=emb, block=1, threshold=9)
        ...
        feature_next_plit_2_1, _ = \
            self.compress_2_1.forward_plit(feature=feature_next_plit_1, z_hat=z_hat_2_1, cbr_z=cbr_z_2_1,
                                            lmb_embedding=emb, block=2, threshold=2)
        feature_next_plit_2_2, _ = \
            self.compress_2_2.forward_plit(feature=feature_next_plit_2_1, z_hat=z_hat_2_2, cbr_z=cbr_z_2_2,
                                            lmb_embedding=emb, block=2, threshold=3)
        feature_next_plit_2 = self.ConvNeXtBlockAdaLN_7_2(feature_next_plit_2_2, emb)
        feature_next_plit_2 = self.patch_upsample_2(feature_next_plit_2)
        feature_next_plit_2 = self.ConvNeXtBlockAdaLN_8_1(feature_next_plit_2, emb)
        ...
        feature_next_plit_3_1, _ = \
            self.compress_3_1.forward_plit(feature=feature_next_plit_2, z_hat=z_hat_3_1, cbr_z=cbr_z_3_1,
                                            lmb_embedding=emb, block=2, threshold=4)
        feature_next_plit_3_2, _ = \
            self.compress_3_2.forward_plit(feature=feature_next_plit_3_1, z_hat=z_hat_3_2, cbr_z=cbr_z_3_2,
                                            lmb_embedding=emb, block=2, threshold=5)
        feature_next_plit_3_3, _ = \
            self.compress_3_3.forward_plit(feature=feature_next_plit_3_2, z_hat=z_hat_3_3, cbr_z=cbr_z_3_3,
                                            lmb_embedding=emb, block=2, threshold=6)
        feature_next_plit_3 = self.ConvNeXtBlockAdaLN_8_2(feature_next_plit_3_3, emb)
        feature_next_plit_3 = self.patch_upsample_3(feature_next_plit_3)
        feature_next_plit_3 = self.ConvNeXtBlockAdaLN_9_1(feature_next_plit_3, emb)
        ...
        feature_next_plit_4_1, _ = \
            self.compress_4_1.forward_plit(feature=feature_next_plit_3, z_hat=z_hat_4_1, cbr_z=cbr_z_4_1,
                                            lmb_embedding=emb, block=2, threshold=7)
        feature_next_plit_4_2, _ = \
            self.compress_4_2.forward_plit(feature=feature_next_plit_4_1, z_hat=z_hat_4_2, cbr_z=cbr_z_4_2,
                                            lmb_embedding=emb, block=2, threshold=8)
        feature_next_plit_4_3, _ = \
            self.compress_4_3.forward_plit(feature=feature_next_plit_4_2, z_hat=z_hat_4_3, cbr_z=cbr_z_4_3,
                                            lmb_embedding=emb, block=2, threshold=9)
        feature_next_plit_4 = self.ConvNeXtBlockAdaLN_9_2(feature_next_plit_4_3, emb)
        feature_next_plit_4 = self.patch_upsample_4(feature_next_plit_4)
        feature_next_plit_4 = self.ConvNeXtBlockAdaLN_10_1(feature_next_plit_4, emb)
        ...
        # calculate parameter
        out_loss_plit=(out_loss_plit_1+out_loss_plit_2)/2
        ...
        return loss,psnr_ntc,psnr_plit_1,psnr_plit_2,kl,cbr_z,bpp
