from layer.HJSCC_EncDec import *
from layer.NTC_HJSCC import *
...
class Model(nn.Module):
    ...
    def forward(self, im, lmb=None,train=1):
        ...
        feature_next_hjscc_1, y_1, kl_1, cbr_y_1 = \
            self.compress_1.forward_hjscc(feature=feature_next_0, initial_image=initial_image, scale_h=1, scale_w=1, enc_feature=feature_1, lmb_embedding=emb, snr=snr)
        feature_next_hjscc_1 = self.ConvNeXtBlockAdaLN_6_1(feature_next_hjscc_1, emb)
        feature_next_hjscc_1 = self.patch_upsample_1(feature_next_hjscc_1)
        feature_next_hjscc_1 = self.ConvNeXtBlockAdaLN_7_1(feature_next_hjscc_1, emb)

        feature_next_hjscc_2_1, y_2_1, kl_2_1, cbr_y_2_1 = \
            self.compress_2_1.forward_hjscc(feature=feature_next_hjscc_1, initial_image=initial_image, scale_h=2,scale_w=2, enc_feature=feature_2, lmb_embedding=emb, snr=snr)
        feature_next_hjscc_2_2, y_2_2, kl_2_2, cbr_y_2_2 = \
            self.compress_2_2.forward_hjscc(feature=feature_next_hjscc_2_1, initial_image=initial_image, scale_h=2,scale_w=2, enc_feature=feature_2, lmb_embedding=emb, snr=snr)
        feature_next_hjscc_2 = self.ConvNeXtBlockAdaLN_7_2(feature_next_hjscc_2_2, emb)
        feature_next_hjscc_2 = self.patch_upsample_2(feature_next_hjscc_2)
        feature_next_hjscc_2 = self.ConvNeXtBlockAdaLN_8_1(feature_next_hjscc_2, emb)

        feature_next_hjscc_3_1, y_3_1, kl_3_1, cbr_y_3_1 = \
            self.compress_3_1.forward_hjscc(feature=feature_next_hjscc_2, initial_image=initial_image, scale_h=2,scale_w=2, enc_feature=feature_3, lmb_embedding=emb, snr=snr)
        feature_next_hjscc_3_2, y_3_2, kl_3_2, cbr_y_3_2 = \
            self.compress_3_2.forward_hjscc(feature=feature_next_hjscc_3_1, initial_image=initial_image, scale_h=2,scale_w=2, enc_feature=feature_3, lmb_embedding=emb, snr=snr)
        feature_next_hjscc_3_3, y_3_3, kl_3_3, cbr_y_3_3 = \
            self.compress_3_3.forward_hjscc(feature=feature_next_hjscc_3_2, initial_image=initial_image, scale_h=2,scale_w=2, enc_feature=feature_3, lmb_embedding=emb, snr=snr)
        feature_next_hjscc_3 = self.ConvNeXtBlockAdaLN_8_2(feature_next_hjscc_3_3, emb)
        feature_next_hjscc_3 = self.patch_upsample_3(feature_next_hjscc_3)
        feature_next_hjscc_3 = self.ConvNeXtBlockAdaLN_9_1(feature_next_hjscc_3, emb)

        feature_next_hjscc_4_1, y_4_1, kl_4_1, cbr_y_4_1 = \
            self.compress_4_1.forward_hjscc(feature=feature_next_hjscc_3, initial_image=initial_image, scale_h=4,scale_w=4, enc_feature=feature_4, lmb_embedding=emb, snr=snr)
        feature_next_hjscc_4_2, y_4_2, kl_4_2, cbr_y_4_2 = \
            self.compress_4_2.forward_hjscc(feature=feature_next_hjscc_4_1, initial_image=initial_image, scale_h=4,scale_w=4, enc_feature=feature_4, lmb_embedding=emb, snr=snr)
        feature_next_hjscc_4_3, y_4_3, kl_4_3, cbr_y_4_3 = \
            self.compress_4_3.forward_hjscc(feature=feature_next_hjscc_4_2, initial_image=initial_image, scale_h=4,scale_w=4, enc_feature=feature_4, lmb_embedding=emb, snr=snr)
        feature_next_hjscc_4 = self.ConvNeXtBlockAdaLN_9_2(feature_next_hjscc_4_3, emb)
        feature_next_hjscc_4 = self.patch_upsample_4(feature_next_hjscc_4)
        feature_next_hjscc_4 = self.ConvNeXtBlockAdaLN_10_1(feature_next_hjscc_4, emb)

        feature_next_hjscc_5 = self.ConvNeXtBlockAdaLN_10_2(feature_next_hjscc_4, emb)
        feature_next_hjscc_5 = self.ConvNeXtBlockAdaLN_10_3(feature_next_hjscc_5, emb)
        feature_next_hjscc_5 = self.ConvNeXtBlockAdaLN_10_4(feature_next_hjscc_5, emb)
        feature_next_hjscc_5 = self.ConvNeXtBlockAdaLN_10_5(feature_next_hjscc_5, emb)
        feature_next_hjscc_5 = self.ConvNeXtBlockAdaLN_10_6(feature_next_hjscc_5, emb)
        feature_next_hjscc_5 = self.ConvNeXtBlockAdaLN_10_7(feature_next_hjscc_5, emb)
        feature_next_hjscc_5 = self.ConvNeXtBlockAdaLN_10_8(feature_next_hjscc_5, emb)
        feature_next_hjscc_5 = self.patch_upsample_5(feature_next_hjscc_5)
        feature_next_hjscc_5_nopad = feature_next_hjscc_5[:, :, :H, :W]

        mse_hjscc = tnf.mse_loss(feature_next_hjscc_5_nopad, x_target, reduction='none').mean(dim=(1, 2, 3))
        out_loss_hjscc = mse_hjscc * 256
        x_hat_hjscc = feature_next_hjscc_5_nopad
        im_hat_hjscc = process_output(x_hat_hjscc.detach())
        im_hat_hjscc_nopad = im_hat_hjscc[:, :, :H, :W]
        im_mse_hjscc = tnf.mse_loss(im_hat_hjscc_nopad, im, reduction='mean')
        psnr_hjscc = -10 * math.log10(im_mse_hjscc.item())

        feature_next_ntc_1 = \
            self.compress_1.forward_ntc(feature=feature_next_0, y=y_1, lmb_embedding=emb)
        ...
        feature_next_ntc_2_1 = \
            self.compress_2_1.forward_ntc(feature=feature_next_ntc_1, y=y_2_1, lmb_embedding=emb)
        feature_next_ntc_2_2 = \
            self.compress_2_2.forward_ntc(feature=feature_next_ntc_2_1, y=y_2_2, lmb_embedding=emb)
        ...
        feature_next_ntc_3_1 = \
            self.compress_3_1.forward_ntc(feature=feature_next_ntc_2, y=y_3_1, lmb_embedding=emb)
        feature_next_ntc_3_2 = \
            self.compress_3_2.forward_ntc(feature=feature_next_ntc_3_1, y=y_3_2, lmb_embedding=emb)
        feature_next_ntc_3_3 = \
            self.compress_3_3.forward_ntc(feature=feature_next_ntc_3_2, y=y_3_3, lmb_embedding=emb)
        ...
        feature_next_ntc_4_1 = \
            self.compress_4_1.forward_ntc(feature=feature_next_ntc_3, y=y_4_1, lmb_embedding=emb)
        feature_next_ntc_4_2 = \
            self.compress_4_2.forward_ntc(feature=feature_next_ntc_4_1, y=y_4_2, lmb_embedding=emb)
        feature_next_ntc_4_3 = \
            self.compress_4_3.forward_ntc(feature=feature_next_ntc_4_2, y=y_4_3, lmb_embedding=emb)
        ...
        # calaclate parameter
        cbr_y = cbr_y_1 + cbr_y_2_1 + cbr_y_2_2 + cbr_y_3_1 + cbr_y_3_2 + cbr_y_3_3 + cbr_y_4_1 + cbr_y_4_2 + cbr_y_4_3
        ...
        loss = (out_loss_hjscc + out_loss_ntc).mean(0) + kl

        return loss, psnr_ntc, psnr_hjscc, kl, cbr_y, bpp