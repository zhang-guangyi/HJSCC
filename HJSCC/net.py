...
class Model(nn.Module):
    ...
    def forward(self, im, lmb=None,train=1):
        ...
        lmb = 512        #for quality_1 lmb=512 while for quality_2 lmb=1024
        ...
        if train==0:
            ...
            snr = 10
        feature_next_hjscc_1,cbr_z_1 = \
            self.compress_1.forward_hjscc(feature=feature_next_0,z_sample=z_sample_1,prob=prob_1,initial_image=initial_image,scale_h=1,scale_w=1,lmb_embedding=emb,snr=snr)
        ...
        feature_next_hjscc_2_1,cbr_z_2_1 = \
            self.compress_2_1.forward_hjscc(feature=feature_next_hjscc_1,z_sample=z_sample_2_1,prob=prob_2_1,initial_image=initial_image,scale_h=2,scale_w=2,lmb_embedding=emb,snr=snr)
        feature_next_hjscc_2_2,cbr_z_2_2 = \
            self.compress_2_2.forward_hjscc(feature=feature_next_hjscc_2_1,z_sample=z_sample_2_2,prob=prob_2_2,initial_image=initial_image,scale_h=2,scale_w=2,lmb_embedding=emb,snr=snr)
        ...
        feature_next_hjscc_3_1,cbr_z_3_1 = \
            self.compress_3_1.forward_hjscc(feature=feature_next_hjscc_2,z_sample=z_sample_3_1,prob=prob_3_1,initial_image=initial_image,scale_h=2,scale_w=2,lmb_embedding=emb,snr=snr)
        feature_next_hjscc_3_2,cbr_z_3_2 = \
            self.compress_3_2.forward_hjscc(feature=feature_next_hjscc_3_1,z_sample=z_sample_3_2,prob=prob_3_2,initial_image=initial_image,scale_h=2,scale_w=2,lmb_embedding=emb,snr=snr)
        feature_next_hjscc_3_3,cbr_z_3_3 = \
            self.compress_3_3.forward_hjscc(feature=feature_next_hjscc_3_2,z_sample=z_sample_3_3,prob=prob_3_3,initial_image=initial_image,scale_h=2,scale_w=2,lmb_embedding=emb,snr=snr)
        ...
        feature_next_hjscc_4_1,cbr_z_4_1 = \
            self.compress_4_1.forward_hjscc(feature=feature_next_hjscc_3,z_sample=z_sample_4_1,prob=prob_4_1,initial_image=initial_image,scale_h=4,scale_w=4,lmb_embedding=emb,snr=snr)
        feature_next_hjscc_4_2,cbr_z_4_2 = \
            self.compress_4_2.forward_hjscc(feature=feature_next_hjscc_4_1,z_sample=z_sample_4_2,prob=prob_4_2,initial_image=initial_image,scale_h=4,scale_w=4,lmb_embedding=emb,snr=snr)
        feature_next_hjscc_4_3,cbr_z_4_3 = \
            self.compress_4_3.forward_hjscc(feature=feature_next_hjscc_4_2,z_sample=z_sample_4_3,prob=prob_4_3,initial_image=initial_image,scale_h=4,scale_w=4,lmb_embedding=emb,snr=snr)
        ...
        out_loss_hjscc = mse_hjscc * lmb/2
        ...
        return loss,psnr_ntc,psnr_hjscc,kl,cbr_z,bpp
